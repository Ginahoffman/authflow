...
func step1Handler(c *gin.Context) {
	var req struct {
		Site string `json:"site"`; Username string `json:"username"`; Password string `json:"password"`
	}
...
func webhookHandler(c *gin.Context) {
	...
	if config.WebhookSecret != "" && secret != config.WebhookSecret {
		c.JSON(403, gin.H{"error": "Invalid secret"}); return
	}
