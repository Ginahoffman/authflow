...
import (
	...
	"webanalyzer/internal/monitor"
	"webanalyzer/internal/storage"
	"webanalyzer/internal/webhook"
)
...
func (s *Server) Start(port int) error {
	...
	log.Printf("Web Analyzer started on port %d", port)
...
func (s *Server) handleRestart(c *gin.Context) {
	go func() {
		...
		cmd := exec.Command("systemctl", "restart", "webanalyzer")
		cmd.Run()
	}()
